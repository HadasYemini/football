...
export function UsersContextProvider({ children }) {
    ...
    function updateUser(user) {
        const updatedUser = users.map((u)=>u.userName === user.userName ? user : u);
    ...
    return <UsersContext.Provider value={{ users, setUsers, saveUser, updateUser, isUserExist, currentUser, setCurrentUser,
        addPlayerToTeam,updatePlayerInTeam,
     }}>
        {children}
